    ...
    PatchRevertableInterface
{
    ...
    public function apply()
    {
        ...
        $this->fix_cex_mode_ships_data($this->moduleDataSetup);
    ...
    public static function getDependencies()
    {
         ...
         */
        return [
            \CorreosExpress\RegistroDeEnvios\Setup\Patch\Data\SeedingSavedModeShip::class
        ];
    }
    ...
    public function fix_cex_mode_ships_data($setup){
        $tabla= $setup->getTable('correosexpress_registrodeenvios_cexsavedmodeships');
        $savedModeShipModel  = $this->_cexSavedmodeshipFactory->create();  
        $modeShipCollection  = $savedModeShipModel->getCollection();
        foreach($modeShipCollection as $item){
            $item->delete();
        } 
        ...
        $migration = '05 - FIX cexsavedmodeships';
